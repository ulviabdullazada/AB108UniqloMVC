...
namespace AB108Uniqlo.Migrations
{
    ...
    [Migration("20241210062712_CreatedUserCodesTable")]
    partial class CreatedUserCodesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AB108Uniqlo.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AB108Uniqlo.Models.User", b =>
                {
            ...
            modelBuilder.Entity("AB108Uniqlo.Models.UserCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AB108Uniqlo.Models.ProductRating", b =>
                {
                    ...
                    b.HasOne("AB108Uniqlo.Models.User", "User")
                        .WithMany("ProductRatings")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AB108Uniqlo.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProductTag", b =>
                {
                    b.HasOne("AB108Uniqlo.Models.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AB108Uniqlo.Models.Tag", null)
                        .WithMany()
